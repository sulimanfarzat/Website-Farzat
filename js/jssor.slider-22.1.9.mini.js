(function(i, g, c, h, e, k, f) { /*! Jssor */
                ...
                b.a(h, function(G) {
                    ...
                    if (a.$Zoom || a.$Rotate) {
                        ...
                        if (H) {
                            ...
                            f.$Zoom = 1;
                            if (b.Yb() || b.Kd()) d.$Zoom = c.min(d.$Zoom, 2);
                            var N = a.$Rotate || 0;
    ...
    var j = i.$JssorSlider$ = function(q, hc) {
        ...
        function Bc(i, f) {
            ...
            function E(a) {
                ...
                T(i, a, 0);
                F = e;
                q = new I.$Class(i, I, b.De(b.k(i, "idle")) || qc, !L);
                q.H(0)
            }
        ...
        function Gb(c, d) {
            ...
            if (!y) {
                ...
                var i = b.Ab(q);
                b.J(q, y);
                b.fb(q, "backgroundImage", "");
                b.a(i, function(c) {
                    b.J(b.k(c, "noscale") ? q : a, c);
        ...
        if (r) {
            ...
            var xb = v,
                ...
                kb = Fb.gf,
                G, qb, Kb, tb;
            Fb.Vd && b.fb(xb, Fb.Vd, ([h, "pan-y", "pan-x", "none"])[Y] || "");
            U = new Dc;
            if (db) A = new sb(Vb, K, J, eb, kb);
            b.J(ib, U.Mb);
            b.lb(v, "hidden");
            O = Zb();
            b.fb(O, "backgroundColor", "#000");
            b.Lb(O, 0);
            ...
            z = new rc(Eb, U);
            b.f(v, "click", mc, e);
            b.f(q, "mouseout", b.Ub(kc, q));
            b.f(q, "mouseover", b.Ub(jc, q));
            if (Y) {
                b.f(v, "mousedown", ac);
                b.f(v, "touchstart", vc);
                b.f(v, "dragstart", Ib);
        ...
        f.Dc = function(E) {
            if (!u) {
                ...
                for (var f = 0; f < s; f++) {
                    ...
                    a.$ActionMode & 2 && b.f(k, "mouseover", b.Ub(b.G(h, t, f), k));
                    y[f] = b.bc(k)
                }
                u = e
            }
    ...
    i.$JssorThumbnailNavigator$ = function(g, B) {
        ...
        function A(o, f) {
            ...
            a.$ActionMode & 2 && b.f(c, "mouseover", b.Ub(b.G(h, j, 1), c))
        }
        i.Gc = function(b, e, f) {
            var a = p;
            p = b;
