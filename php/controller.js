                ...
                $http.post("action.php", data, config).success(function (response) {
                    if (response.status == 'OK') {
                        if (type == 'edit') {
                            ...
                            $scope.users[$scope.index].product_name = $scope.tempUserData.product_name;
                            $scope.users[$scope.index].product_price = $scope.tempUserData.product_price;
                            $scope.users[$scope.index].edit_from = $scope.tempUserData.edit_from;
                            ...
                            $scope.users.push({
                                ...
                                edit_from: response.data.edit_from,
